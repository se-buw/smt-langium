...
- [src/smt.langium](src/smt.langium) -  The grammar definition of your language
- [src/smt-module.ts](src/smt-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/smt-validator.ts](src/smt-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/smt.monarch.ts](src/syntaxes/smt.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/smt.tmLanguage.json](syntaxes/smt.tmLanguage.json) - Textmate based syntax highlighting instructions.
